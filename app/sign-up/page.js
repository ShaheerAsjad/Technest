...
export default function SignUpPage() {
  return (
    <div className="auth-page">
      ...
      <div className="auth-left">
        ...
        <div className="auth-left-content">
          ...
          <p className="auth-left-sub">
            Create an account to unlock exclusive drops and personalized recommendations.
          </p>
      ...
      {/* RIGHT HALF — Glassmorphic Sign Up Form */}
        ...
        <div className="auth-card-wrap">
          ...
          <div className="auth-glass-card">
            ...
            <div className="auth-card-header">
              ...
              <p className="auth-card-sub">Join TechNest to get started</p>
            </div>
            ...
            <div className="auth-social-row">
              <button type="button" className="auth-social-btn" aria-label="Google sign up">
              ...
              <button type="button" className="auth-social-btn" aria-label="Apple sign up">
              ...
              <button type="button" className="auth-social-btn" aria-label="GitHub sign up">
            ...
            <div className="auth-footer-text">
              Already have an account? <Link href="/sign-in" className="auth-footer-link">Sign in</Link>
            </div>
          </div>
        </div>
      </div>
